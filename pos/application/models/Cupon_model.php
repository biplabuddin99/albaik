...
class Cupon_model extends CI_Model {
	...
	public function update_cupon(){
        ...
        $query1="update db_cupon set cupon_name='$cupon_name',cupon_code='$cupon_code',number_of='$number_of',start_date='$start_date',finish_date='$finish_date',discount_type='$discount_type',discount='$discount',status='$status' where id=$q_id";
        if ($this->db->simple_query($query1)){
