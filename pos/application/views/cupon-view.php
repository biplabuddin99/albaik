...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$page_title;?>
        <small>View/Search Items Cupon</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>cupon/add">
                <i class="fa fa-plus"></i> <?= $this->lang->line('add_cupon'); ?></a>
              </div>
              <?php } ?>
            </div>
            <!-- /.box-header -->
...
$(document).ready(function() {
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "ajax": {
            "url": "<?php echo site_url('cupon/ajax_list')?>",
            "type": "POST",
        ...
        "columnDefs": [
        {
            "targets": [ 0,5,7,8 ], //first column / numbering column
