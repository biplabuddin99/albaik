      ...
      <div class="row">
        ...
        <?= form_open('#', array('class' => 'form', 'id' => 'category-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
				...
				<div class="form-group">
                  <label for="question" class="col-sm-2 control-label"><?= $this->lang->line('question'); ?></label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" value="<?php print $question; ?>" id="question" name="question" placeholder="">
					<span id="question_msg" style="display:none" class="text-danger"></span>
                  </div>
                </div>
				<div class="form-group">
...
<script src="<?php echo $theme_link; ?>js/faq.js"></script>
