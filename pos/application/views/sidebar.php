...
<header class="main-header">
  ...
  <aside class="main-sidebar">
    ...
    <?php if($CI->permissions('sales_add')  || $CI->permissions('sales_view') || $CI->permissions('sales_return_view') || $CI->permissions('sales_return_add')) { ?>
        ...
        <?php if($CI->permissions('sales_add')) { ?>
            <li class="pos-active-li hidden"><a href="<?php echo $base_url; ?>pos"><i class="fa fa-calculator "></i> <span>POS</span></a></li>
    ...
    <?php if($CI->permissions('purchase_add') || $CI->permissions('purchase_view') || $CI->permissions('purchase_return_view') || $CI->permissions('new_purchase_return')) { ?>
        ...
        <li class="items-list-active-li items-active-li  category-view-active-li category-active-li brand-active-li brand-view-active-li labels-active-li import_items-active-li treeview">
          ...
          <ul class="treeview-menu">
            ...
            <?php } ?>
            <?php if($CI->permissions('items_subcategory_add')) { ?>
            <li class="category-active-li"><a href="<?php echo $base_url; ?>subcategory/add"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('new_subcategory'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('items_subcategory_view')) { ?>
            <li class="category-view-active-li"><a href="<?php echo $base_url; ?>subcategory/view"><i class="fa fa-list "></i> <span><?= $this->lang->line('subcategories_list'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('items_childcategory_add')) { ?>
            <li class="category-active-li"><a href="<?php echo $base_url; ?>childcategory/add"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('new_childcategory'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('items_childcategory_view')) { ?>
            <li class="category-view-active-li"><a href="<?php echo $base_url; ?>childcategory/view"><i class="fa fa-list "></i> <span><?= $this->lang->line('childcategories_list'); ?></span></a></li>
            <?php } ?>
            ...
            <?php } ?>
            <?php if($CI->permissions('items_cupon_add')) { ?>
        ...
        <li class="expense-list-active-li expense-active-li expense-category-active-li expense-category-list-active-li treeview">
          <a href="#">
            <i class="fa fa-exchange text-aqua"></i> <span><?= $this->lang->line('stock'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <?php if($CI->permissions('stock_exchange')) { ?>
            <li class="expense-active-li"><a href="<?php echo $base_url; ?>stock/add"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('stock_exchange'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('stock')) { ?>
            <li class="expense-list-active-li"><a href="<?php echo $base_url; ?>stock"><i class="fa fa-list "></i> <span><?= $this->lang->line('stock_list'); ?></span></a></li>
            <?php } ?>
          </ul>
        </li>
        <?php } ?>
    ...
    <?php if($CI->permissions('item_purchase_report') ||$CI->permissions('sales_report') || $CI->permissions('item_sales_report') || $CI->permissions('purchase_report') || $CI->permissions('purchase_return_report') || $CI->permissions('expense_report') || $CI->permissions('profit_report') || $CI->permissions('stock_report') || $CI->permissions('purchase_payments_report') || $CI->permissions('sales_payments_report') || $CI->permissions('expired_items_report')) { ?>
		<li class="report-sales-active-li report-sales-return-active-li report-purchase-active-li report-purchase-return-active-li report-expense-active-li report-profit-loss-active-li report-stock-active-li report-purchase-payments-active-li report-sales-item-active-li report-sales-payments-active-li report-expired-items-active-li report-purchase-item-active-li treeview">
          ...
          <ul class="treeview-menu">
            ...
            <?php } ?>
			<?php if($CI->permissions('profit_report')) { ?>
            <li class="report-profit-loss-active-li"><a href="<?php echo $base_url; ?>reports/statement/cash" ><i class="fa fa-files-o "></i> <span><?= "Cash Statement" ?></span></a></li>
			<li class="report-profit-loss-active-li"><a href="<?php echo $base_url; ?>reports/statement/bank" ><i class="fa fa-files-o "></i> <span><?= "Bank Statement" ?></span></a></li>
            <?php } ?>
            ...
            <?php } ?>
            <?php if($CI->permissions('item_purchase_report')) { ?>
            <li class="report-purchase-item-active-li"><a href="<?php echo $base_url; ?>reports/item_purchase" ><i class="fa fa-files-o "></i> <span><?= $this->lang->line('item_purchase_report'); ?></span><span class="pull-right-container"></span></a></li>
            <?php } ?>
      ...
      <?php } ?>
        ...
        <li class="sms-active-li sms-api-active-li sms-template-active-li sms-templates-list-active-li treeview">
		 ...
		 <li class="trnsactions-active-li"><a href="<?php echo $base_url; ?>transactions"><i class="fa fa-money"></i><span><?= $this->lang->line('transactions'); ?></span></a></li>
        <?php } ?>
		...
		<li class=" company-profile-active-li site-settings-active-li  change-pass-active-li dbbackup-active-li warehouse-active-li warehouse-list-active-li tax-active-li currency-view-active-li currency-active-li  database_updater-active-li tax-list-active-li units-list-active-li unit-active-li payment_types_list-active-li payment_types-active-li treeview">
          ...
          <ul class="treeview-menu">
          <?php if($CI->permissions('headslide_add')) { ?>
