			...
			<td>
				...
				<table width="100%" cellpadding="0" cellspacing="0"  >
					...
					<tfoot>
					 ...
					 <tr >
						<td style=" padding-left: 2px; padding-right: 2px;" colspan="5" align="right"><?= $this->lang->line('before_tax'); ?></td>
					...
					<tr>
						<td style=" padding-left: 2px; padding-right: 2px;" colspan="5" align="right"><?= $this->lang->line('discount'); ?> <?= ($discount_to_all_type=='in_percentage') ? $discount_to_all_input .'%' : $discount_to_all_input.'[Fixed]' ;?></td>
					...
					<tr>
                        ...
                        <tr>
    						<td colspan="6" align="center">
    							Powerd by Muktodhara Technology Ltd
    						</td>
    					</tr>
					</tfoot>
				</table>
