					...
					<table class="table table-bordered" style="width:60%;margin:0 auto" id="statementTable"> 
						...
						<tbody>
							...
							<?php 
								...
								foreach($statement['expenses'] as $expens){
									$totalExpense+=$expens->expense_amt;
							?>
							<tr> 
								<td class='text-center'><?=$expens->expense_date?></td>
								<td class="invoice-td"><strong>#</strong><?=$expens->expense_for?></td>
								<td class='text-center'><?=$expens->expense_amt?></td>
								<td class='text-center'></td>
							</tr>
							<?php } ?>
							<tr> 
